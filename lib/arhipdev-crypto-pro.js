 ...
 * @returns подпись в формате PKCS#7
 */
exports.createDetachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, messageHash, attributes) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    return eval(_generateCadesFn_1._generateCadesFn(function createDetachedSignature() {
        ...
        try {
            ...
            if (attributes.commentAttr) {
                void (_generateCadesFn_1.__cadesAsyncToken__ + cadesAttrs.propset_Name('1.2.643.2.45.1.1.1'));
                void (_generateCadesFn_1.__cadesAsyncToken__ + cadesAttrs.propset_Value(attributes.commentAttr));
            }
            // Set usageAttr
            if (attributes.usageAttr) {
                void (_generateCadesFn_1.__cadesAsyncToken__ + cadesAttrs.propset_Name('1.2.643.2.45.1.1.3'));
                void (_generateCadesFn_1.__cadesAsyncToken__ + cadesAttrs.propset_Value(attributes.usageAttr));
            }
        }
        catch (error) {
            console.error(error);
 ...
 * @returns подпись
 */
exports.createXMLSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, isTemplate = false) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
